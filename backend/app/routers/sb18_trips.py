...
# UPDATED: Trip Management API
# Handles trip creation, retrieval, daily totals, and income tracking
# FIXED: Changed imports from app.schemas.trips to app.schemas.trip and removed undefined DailyTotalResponse
...
async def get_trip_history(
    ...
    query = db.query(Trip).filter(Trip.rider_id == rider_id, Trip.status == 'active')
