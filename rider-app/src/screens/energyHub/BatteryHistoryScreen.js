...
// ✅ Battery history screen (reuses FuelHistoryScreen logic for battery entries)
...
export default function BatteryHistoryScreen({ navigation }) {
  ...
  // FIXED: Changed limit from 1000 to 50 (backend maximum)
  useEffect(() => {
    let isMounted = true;
    ...
    async function fetchAllEntries() {
      try {
        setLoading(true);
        // Filter for swap and charging entries (battery-only)
